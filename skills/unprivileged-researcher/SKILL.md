...
1. Copy `~/.agents/skills/unprivileged-researcher/scratchpads/template.md` to the scratchpad path provided by the user.
...
```text
~/.agents/skills/unprivileged-researcher/scratchpads/template.md
```
