...
from orchestrator_constants import CONTINUE_PROMPT, STALE_TIMER_GRACE_SECONDS
...
class TimerManager:
    ...
    def __init__(
        ...
        *,
        ...
        self._script_path = script_path or Path(__file__).resolve().with_name("orchestrator.py")
